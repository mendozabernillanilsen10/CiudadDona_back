...
public class StoreControllers {
	...
	public ResponseEntity<List<CategoriaDTO>> obtenerTiendasPorDistrito(@PathVariable Long pIdDistrito,
			@PathVariable UUID pIdCategoria, @PathVariable UUID pIdSubcategoria) {
		List<Store> cats = storeservice.obtenerTiendasPorDistrito(pIdDistrito, pIdCategoria, pIdSubcategoria);
